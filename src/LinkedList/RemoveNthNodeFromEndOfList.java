...
public class RemoveNthNodeFromEndOfList {
    ...
    //this one is only one pass solution. Move one pointer fast --> n+1 places forward, to maintain a gap of n
    //between the two pointers and then move both at the same speed.
